...
SELECT 
    ...
    CASE 
        ...
        ELSE NULL
    END AS well_type,
    'Deepening' AS task_type,
    data."WELL_TYPE_NAME" as well_name,
    data."DEEP_LOC_SURFACE_LATI" as well_location_surface_latitude,
    data."DEEP_LOC_SURFACE" as well_location_surface_longitude,
    data."DEEP_LOC_SUB_SURFACE_LATI" as well_location_sub_surface_latitude,
    data."DEEP_LOC_SUB_SURFACE" as well_location_sub_surface_longitude,
    CASE 
        WHEN data."DEEP_WELL_COURSE_TYPE" = '1' THEN 'Vertical'
        ELSE 'Inclined'
    END AS well_course,
    CAST(data."DEEP_TAG_WELL_DEPTH_MET" AS numeric(30,2)) as target_well_depth_offshore,
    CAST(data."DEEP_INT_DEPTH_MET" AS NUMERIC(30,2)) as intended_well_depth_offshore,
    data."DEEP_EXP_GEO_OBJ" as expected_geological_objective,
    CASE 
...
WHERE data."DEEP_WELL_COURSE_TYPE" = '1' OR data."DEEP_WELL_COURSE_TYPE" = '2';