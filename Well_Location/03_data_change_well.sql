...
SELECT 
    ...
    data."CHAN_LOC_SURFACE" as well_location_surface_longitude,
    data."CHAN_LOC_SUB_SURFACE_LATI" as well_location_sub_surface_latitude,
    data."CHAN_LOC_SUB_SURFACE" as well_location_sub_surface_longitude,
    CASE 
        WHEN data."CHAN_WELL_COURSE_TYPE" = '1' THEN 'Vertical'
        ELSE 'Inclined'
    END AS well_course,
    CAST(data."CHAN_TAG_WELL_DEPTH" AS numeric(30,2)) as target_well_depth_offshore,
    CAST(data."CHAN_INT_DEPTH" AS NUMERIC(30,2)) as intended_well_depth_offshore,
    data."CHAN_EXP_GEO_OBJ" as expected_geological_objective,
    1 as is_active,
    1 as is_migrated
...
WHERE data."CHAN_WELL_COURSE_TYPE" = '1';