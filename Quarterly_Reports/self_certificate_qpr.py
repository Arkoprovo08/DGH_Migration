...
def upload_documents():
    try:
        ...
        fetch_query = """
            ...
            JOIN upstream_data_management.t_quarterly_report_header taad
            ON fwmn.ref_id = taad.quarterly_report_application_number
        ...
        for ref_id, file_name, block_category, block_name, created_on in records:
            ...
            try:
                ...
                if doc_id:
                    ...
                    update_audit = """
                        UPDATE upstream_data_management.t_quarterly_report_header
                        SET self_certificate_id = %s,
                            self_certificate_file_name = %s,
                            self_certificate_generation_date = NOW()
                        WHERE quarterly_report_application_number = %s
                    """
