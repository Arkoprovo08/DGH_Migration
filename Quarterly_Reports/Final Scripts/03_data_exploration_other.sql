WITH mapped AS (
    SELECT 
        a.refid,
        REPLACE(a.label, '_', ' ') AS other_activity,  -- replace underscores with spaces
        a.work_prog_qut_act,
        a.planned_qut_act,
        a.actual_qut_act,
...
SELECT 
    ...
    NULL AS activity_id,              -- force NULL
    m.other_activity,                 -- label with spaces
    m.work_prog_qut_act,
    m.planned_qut_act,
    m.actual_qut_act,
