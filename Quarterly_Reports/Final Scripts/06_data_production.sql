WITH mapped AS (
    SELECT 
        ...
        a.label,
        CASE TRIM(a.label)
        	WHEN 'BHP_Survey' THEN 20
            WHEN 'CTUoperations' THEN 23
            WHEN 'No_Of_Wells_Planned_To_Be_On_Production_For_The_Year' THEN 24
            WHEN 'Slick_Line_Services' THEN 21
            WHEN 'Steaming_Services' THEN 22
            WHEN 'Studies_To_Be_Carried_Out' THEN 25
            WHEN 'Well_Testing' THEN 19
            WHEN 'Work_Over_Operations' THEN 18
        END AS activity_id
    ...
    WHERE a.status = 1
      AND a.refid = 'QPR-20221027041057' and a.type = 'PRODUCTION' 
      and a.label in
      (
		'BHP_Survey',
		'CTUoperations',
...
INSERT INTO upstream_data_management.t_quarterly_report_production_activities  (
    quarterly_report_id,
    activity_id,
