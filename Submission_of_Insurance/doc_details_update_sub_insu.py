...
try:
    ...
    pg_cursor.execute("""
        SELECT cmf.refid, cf.file_name, cf.logical_doc_id, cf.label_id,
               taad.insurance_and_indemnity_id
        ...
        JOIN financial_mgmt.t_submission_of_insurance_and_indemnity  taad 
            ON taad.insurance_and_indemnity_application_number   = cmf.refid
    ...
    for refid, file_name, logical_doc_id, label_id, appointment_auditor_id in rows:
        pg_cursor.execute("""
            INSERT INTO financial_mgmt.t_submission_of_insurance_and_indemnity_document_details (
                document_ref_number,
                document_type_id,
                document_name,
