...
try:
    ...
    pg_cursor.execute("""
        SELECT cmf.refid, cf.file_name, cf.logical_doc_id, cf.label_id,
               taad.site_restoration_abandonment_details_id 
        ...
        JOIN site_restoration.t_site_restoration_abandonment_details  taad 
            ON taad.site_restoration_abandonment_application_number    = cmf.refid
